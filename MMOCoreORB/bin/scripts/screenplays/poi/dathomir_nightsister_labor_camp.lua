...
function NightSisterLaborCampScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "nightsister_outcast",600,2553,123,-1680,-54,0)
	spawnMobile("dathomir", "nightsister_ranger",720,2543,110.8,-1610,51,0)
	spawnMobile("dathomir", "escaped_nightsister_slave",600,2540,126.3,-1604,-24,0)
	...
	spawnMobile("dathomir", "escaped_nightsister_slave",600,2450,110.0,-1600,80,0)		
	...
	spawnMobile("dathomir", "nightsister_elder",1200,72.1,-45.7,-142.8,86,8575585)
	spawnMobile("dathomir", "nightsister_initiate",600,90.2,-61.2,-7.9,-153,8575577)
	spawnMobile("dathomir", "nightsister_slave",600,83.6,-65.3,-28.6,7,8575577)
	spawnMobile("dathomir", "nightsister_slave",600,84.9,-64.0,-24.5,2,8575577)	
	spawnMobile("dathomir", "nightsister_slave",600,86.2,-65.0,-28.9,2,8575577)
	...
	spawnMobile("dathomir", "nightsister_slave",600,61.2,-69.1,-125.9,2,8575580)
	spawnMobile("dathomir", "nightsister_slave",600,57.7,-68.6,-126.4,2,8575580)
	spawnMobile("dathomir", "nightsister_slave",600,59.0,-69.4,-124.4,2,8575580)
	spawnMobile("dathomir", "nightsister_slave",600,59.7,-68.6,-127.1,2,8575580)
	...
	spawnMobile("dathomir", "nightsister_sentinel",600,114.4,-66.9,-86.0,-143,8575582)
	spawnMobile("dathomir", "nightsister_sentinel",600,110.8,-66.8,-85.8,135,8575582)
	spawnMobile("dathomir", "nightsister_sentinel",600,112.9,-67.2,-87.6,2,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,126.6,-66.6,-110.8,2,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,126.2,-66.7,-107.6,2,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,124.3,-66.8,-109.3,2,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,125.3,-66.8,-107.3,2,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,135.4,-66.4,-119.9,-155,8575582)
	spawnMobile("dathomir", "nightsister_slave",600,134.8,-66.2,-117.7,-125,8575582)
	spawnMobile("dathomir", "nightsister_sentinel",600,156.0,-65.4,-129.4,2,8575582)
	spawnMobile("dathomir", "nightsister_sentinel",600,155.9,-65.4,-126.0,2,8575582)
	spawnMobile("dathomir", "nightsister_sentinel",600,154.2,-65.7,-128.5,2,8575582)
