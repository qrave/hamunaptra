...
function FortTuskenScreenPlay:spawnMobiles()
	...
	spawnMobile("tatooine", "tusken_witch_doctor",720,1.3,1.5,-10.8,118,1189175)
	spawnMobile("tatooine", "tusken_observer",900,0.8,1.7,-7.5,-11,1189175)
	spawnMobile("tatooine", "tusken_executioner",1200, -1.54, 1.58, 0.90,-102,1189175)
	...
	spawnMobile("tatooine", "tusken_witch_doctor",720,2.17, 8.36, -32.02,118,1189178)
	spawnMobile("tatooine", "tusken_executioner", 1200, 6.54, 8.0, -34.17, 180, 1189178)
	spawnMobile("tatooine", "tusken_observer",900,8.5,8.2,-33.5,0,1189178)
	spawnMobile("tatooine", "tusken_observer",900,1.2,8.15,-20.5,0,1189178)
	spawnMobile("tatooine", "tusken_observer",900,3.07, 8.31, -39.26,0,1189178)
	...
	spawnMobile("tatooine", "tusken_executioner",1200,20.8,22.9,-15.2,-102,1189183)
