...
String LootManagerImplementation::getRandomLootableMod( unsigned int sceneObjectType, const String& lootTemplateName) {
	...
	// Here we piggyBack off how clothingAttachments work currently in order to make custom clothingAttachment group!
	// SceneObjectType::CLOTHINGATTACHMENT is a hardcoded sceneObject value in the client!
