...
#include "server/zone/objects/creature/commands/SaberComboHit1Command.h"
#include "server/zone/objects/creature/commands/SaberComboHit2Command.h"
#include "server/zone/objects/creature/commands/SaberComboHit3Command.h"
...
#include "server/zone/objects/creature/commands/SaberHeadHit1Command.h"
#include "server/zone/objects/creature/commands/SaberHeadHit2Command.h"
#include "server/zone/objects/creature/commands/SaberHeadHit3Command.h"
...
#include "server/zone/objects/creature/commands/SaberBodyHit1Command.h"
#include "server/zone/objects/creature/commands/SaberBodyHit2Command.h"
#include "server/zone/objects/creature/commands/SaberBodyHit3Command.h"
...
#include "server/zone/objects/creature/commands/SaberSweep1Command.h"
#include "server/zone/objects/creature/commands/SaberSweep2Command.h"
#include "server/zone/objects/creature/commands/SaberSweep3Command.h"
...
#include "server/zone/objects/creature/commands/SaberLegHit1Command.h"
#include "server/zone/objects/creature/commands/SaberLegHit2Command.h"
#include "server/zone/objects/creature/commands/SaberLegHit3Command.h"
#include "server/zone/objects/creature/commands/SaberSpinAttack1Command.h"
#include "server/zone/objects/creature/commands/SaberSpinAttack2Command.h"
#include "server/zone/objects/creature/commands/SaberSpinAttack3Command.h"
...
void CommandConfigManager::registerCommands3() {
	...
	commandFactory.registerCommand<SaberComboHit1Command>(String("saberComboHit1").toLowerCase());
	commandFactory.registerCommand<SaberComboHit2Command>(String("saberComboHit2").toLowerCase());
	commandFactory.registerCommand<SaberComboHit3Command>(String("saberComboHit3").toLowerCase());
	...
	commandFactory.registerCommand<SaberHeadHit1Command>(String("saberHeadHit1").toLowerCase());
	commandFactory.registerCommand<SaberHeadHit2Command>(String("saberHeadHit2").toLowerCase());
	commandFactory.registerCommand<SaberHeadHit3Command>(String("saberHeadHit3").toLowerCase());
	...
	commandFactory.registerCommand<SaberBodyHit1Command>(String("saberBodyHit1").toLowerCase());
	commandFactory.registerCommand<SaberBodyHit2Command>(String("saberBodyHit2").toLowerCase());
	commandFactory.registerCommand<SaberBodyHit3Command>(String("saberBodyHit3").toLowerCase());
	...
	commandFactory.registerCommand<SaberSweep1Command>(String("saberSweep1").toLowerCase());
	commandFactory.registerCommand<SaberSweep2Command>(String("saberSweep2").toLowerCase());
	commandFactory.registerCommand<SaberSweep3Command>(String("saberSweep3").toLowerCase());
	...
	commandFactory.registerCommand<SaberLegHit1Command>(String("saberLegHit1").toLowerCase());
	commandFactory.registerCommand<SaberLegHit2Command>(String("saberLegHit2").toLowerCase());
	commandFactory.registerCommand<SaberLegHit3Command>(String("saberLegHit3").toLowerCase());
	commandFactory.registerCommand<SaberSpinAttack1Command>(String("saberSpinAttack1").toLowerCase());
	commandFactory.registerCommand<SaberSpinAttack2Command>(String("saberSpinAttack2").toLowerCase());
	commandFactory.registerCommand<SaberSpinAttack3Command>(String("saberSpinAttack3").toLowerCase());
